"""
Django settings for the applelab project.
"""
...
MIDDLEWARE = [
    ...
    "applelab.middleware.ContentSecurityPolicyMiddleware",
]

ROOT_URLCONF = "applelab.urls"
...
WSGI_APPLICATION = "applelab.wsgi.application"
ASGI_APPLICATION = "applelab.asgi.application"
...
if db_engine == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": db_engine,
            "NAME": os.environ.get("DB_NAME", "applelab_db"),
...
AUTH_REFRESH_COOKIE_NAME = os.environ.get("AUTH_REFRESH_COOKIE_NAME", "applelab_refresh")
