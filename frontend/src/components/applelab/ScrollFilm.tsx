...
const FRAMES: { src: string; alt: string }[] = [
  { src: '/applelab/device-macbook-pro.jpg', alt: 'MacBook resting, screen dark' },
  { src: '/applelab/hero-05.jpg', alt: 'Technician inspecting the keyboard' },
  { src: '/applelab/hero-06.jpg', alt: 'Bottom case lifted away from the chassis' },
  { src: '/applelab/hero-07.jpg', alt: 'Driver removing internal screws' },
  { src: '/applelab/hero-11.jpg', alt: 'Battery being lifted out' },
  { src: '/applelab/hero-12.jpg', alt: 'Speakers lifted from the chassis' },
  { src: '/applelab/hero-13.jpg', alt: 'Tweezers disconnecting a ribbon cable' },
  { src: '/applelab/hero-04.jpg', alt: 'Tweezers seating a keycap' },
  { src: '/applelab/hero-08.jpg', alt: 'Logic board, fully exposed' },
  { src: '/applelab/hero-14.jpg', alt: 'Every component laid out in order' },
  { src: '/applelab/hero-06.jpg', alt: 'Chassis closing back up' },
  { src: '/applelab/device-macbook-pro.jpg', alt: 'MacBook reassembled' },
]

const CAPTIONS = [
  { n: '01', text: 'Free diagnosis — every fault, found', in: 0.07, out: 0.24 },
  { n: '02', text: 'Opened with care — board-level access', in: 0.26, out: 0.4 },
  { n: '03', text: 'Genuine parts, surgical hands', in: 0.43, out: 0.66 },
  { n: '04', text: 'Every component, accounted for', in: 0.7, out: 0.86 },
]
      ...
      <div className="film-sticky">
        <div className="film-stage">
          ...
          <div className="film-intro" ref={introRef}>
            <p className="film-eyebrow">The Apple Lab process</p>
            <h2 className="film-h">
              Watch a MacBook
              <br />
              come <span className="gradient-text">back to life.</span>
            </h2>
          </div>
          {CAPTIONS.map((cap, i) => (
            <div
          ...
          <div className="film-outro" ref={outroRef}>
            <h2 className="film-h">
              <span className="gradient-text">Reborn.</span>
            </h2>
            <p>Genuine parts. 90-day warranty. Like it never happened.</p>
          ...
          <span className="film-credit">Repair photography — iFixit</span>
        </div>
